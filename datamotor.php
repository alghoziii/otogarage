                        ...
                        <div class="container mt-5">
                            <div class="col-md-8 mx-auto">
                                <div class="card">
                                    ...
                                    <div class="card-body ">
                                        <h3 class="text-center">Data Motor Otogarage</h3>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div>
                                                <a type="button" class="btn btn-primary mb-2"
                                                    href="tambahdatamotor.php">Tambah Data Motor</a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-striped table-hover table-bordered">
                                                ...
                                                if(isset($_POST['bcari'])){
                                                 //tampilkan data yg di cari
                                                     $keyword = $_POST['tcari'];
                                                     $q = "SELECT * FROM motor WHERE merk like '%keyword%' or no_plat like '%$keyword%'  or merk like '%$keyword%' order by id_motor desc";
                                                }else{
                                                      $q = "SELECT * FROM motor order by id_motor  desc";
                                                    }
                                                        //menampilkan data   
                                                            $no = 1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="editdatamotor.php?hal=edit&id=<?=$data['id_motor'] ?>"
                                                            class="btn btn-warning">Edit</a>



                                                        <a href="hapusdatamotor.php?hal=hapus&id=<?=$data['id_motor'] ?>"
                                                            class="btn btn-dark"
